...
|6:4  |CAN_TS2 |Time Segment 2             |Time Segment 2 (Phase Segment 2)の時間(Tts2)を設定します。このフィールドには、Tqのサイクル数を設定します。 |R/W
|3:0 |CAN_TS1  |Time Segment 1             |Time Segment 1 (Propagation Segmentと Phase Segment 1の合計値)の時間 (Tts1)を設定します。このフィールドには、Tqのサイクル数を設定します。 |R/W
|===
